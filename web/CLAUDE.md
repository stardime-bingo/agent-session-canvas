...
**v17 根治已完成**：LE-008～LE-014 已收口 rendered frame、局部槽、相机尾窗、direct/batch carry、draft journal、BinaryFiles、自动沉底撤销、toast 可达性与静态 4518/build 闭包；2026-07-18 又关闭草稿冲突出路和 Retina 视觉/命中不同尺缺口。后续 SceneStore 另立 RFC，不在本轮扩张。
