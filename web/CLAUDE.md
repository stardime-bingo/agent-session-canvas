...
**v17 根治进行中**：LE-008/009 已收口 rendered frame 与稳定局部槽；LE-010 已收口相机尾窗，LE-011R/LE-011B 已收口 direct/batch carry；LE-012 已实现本地 draft journal 与 BinaryFiles 安全事务，待 Loop 独立验收。LE-013/014 未通过前不得宣告根治。
...
src/canvas/drawing-draft-store.js: 浏览器 IndexedDB 单 active 草稿 journal；requestId+epoch 条件清理、seq 防抖串写、sceneToken+事务闭包+baseline 指纹精确恢复，merged 指纹识别已提交旧记录；quota/不可用只提示一次且不阻断主提交
