/**
 * [INPUT]: 依赖 react-dom 的 createPortal、drawing 的 drawingBounds/isBelow
 * [OUTPUT]: 对外提供 MiniMapInk 组件：把绘图元素画进 React Flow 小地图——镜像其 svg viewBox，零重复投影数学
...
export default function MiniMapInk({ elements, rootRef }) {
  ...
  return createPortal(
    <svg className="mini-ink" viewBox={viewBox}>
      {elements.map(el => {
