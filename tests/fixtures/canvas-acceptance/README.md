...
- layout-quality：production `FlowCanvas + SceneStore + TopBar` 的匿名乱序地图；真实点击“智能整理”，验证工作区活跃度行对齐、1–4 条平衡车道、画板压缩并参与排布、街区终点持久化、容器墨迹随行、便签不动及一键撤销，同时采集同步耗时、首帧与 Long Task。
