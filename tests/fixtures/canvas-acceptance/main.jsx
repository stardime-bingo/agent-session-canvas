/**
 * [INPUT]: 4518 query(mode=performance|interaction|performance-352|hero, size=300|800) 与真实画布组件
 ...
 *           hero=production FlowCanvas 匿名产品截图页；
...
const MODE = ['interaction', 'performance-352', 'hero'].includes(params.get('mode'))
  ? params.get('mode')
  : 'performance';
